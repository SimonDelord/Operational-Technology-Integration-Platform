...
BuildConfigs clone **`poc/truck-fleet`** from GitHub (`SimonDelord/Operational-Technology-Integration-Platform`, branch `main`). **Push this repo before building**, or point `git.uri` in `05-buildconfigs.yaml` at your fork.
