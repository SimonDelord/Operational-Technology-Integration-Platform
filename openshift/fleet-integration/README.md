...
Kafka orchestration for truck destination routing and crusher fill from truck dumps. See design docs: **[fleet-integration/README.md](../../fleet-integration/README.md)**.
