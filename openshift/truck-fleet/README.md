...
Destination routing is handled by **`fleet-integration`** — see **[fleet-integration/README.md](../../fleet-integration/README.md)**.
...
**Note:** BuildConfigs pull from `https://github.com/SimonDelord/Operational-Technology-Integration-Platform.git` on `main`. Push this repo first, or edit `git.uri` in `05-buildconfigs.yaml` to your fork.
...
Application source: **`../../poc/truck-fleet/`**. Design docs: **[truck-fleet/README.md](../../truck-fleet/README.md)**.
